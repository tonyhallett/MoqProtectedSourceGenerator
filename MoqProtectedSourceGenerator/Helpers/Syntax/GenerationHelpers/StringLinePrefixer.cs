...
{
    public static class StringLinePrefixer
    {
        public static string PrefixEachLine(this string self, string prefix)
        {
        ...
        private static string GetLineTerminator(this string self)
        {
            if (self.Contains("\r\n")) // windows
                return "\r\n";
